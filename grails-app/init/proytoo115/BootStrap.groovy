...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        User.withTransaction { us ->
            testUser = new User(username: 'jacksparrow', password: 'password1', fullname: 'Jack Sparrow', email: 'fermerinonew@gmail.com',phoneNumber: '72727281',countryCode: '+503',authyUserId: 320119439,newUser: true).save(flush: true)
        }
